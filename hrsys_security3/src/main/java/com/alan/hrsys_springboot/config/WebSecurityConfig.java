package com.alan.hrsys_springboot.config;

import com.alan.hrsys_springboot.service.impl.UserDetailsServiceImpl;
import com.alan.hrsys_springboot.util.MyAccessDecisionManager;
import com.alan.hrsys_springboot.util.MyFilterInvocationSecurityMetadataSource;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.formLogin()
                ...
                .permitAll()
                .and()
                .logout().logoutUrl("/lgot").logoutSuccessUrl("/login")
                .and()
                .authorizeRequests()
                //按照角色划分
                /*.antMatchers("/sysUser/**", "/sysRole/**", "/sysPermission/**").hasRole("ADMIN")
